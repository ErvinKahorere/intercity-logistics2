...
function openMention(r) {
    ...
    mentionForm.driver_id = r.driver_id;
    mentionForm.text = "";
}
function closeMention() {
    isMentionOpen.value = false;
    mentionForm.schedule_id = null;
    mentionForm.driver_id = null;
    mentionForm.text = "";
}
...
async function sendMention() {
    ...
    try {
        await api.post("/admin/schedules/mention", {
            ...
            driver_id: mentionForm.driver_id,
...
<template>
    <AuthenticatedLayout title="Drivers Schedules">
